...
// java.util.ArrayList -> implementation of List interface
public class ListDemo {
    ...
    public static void show() {
        ...
        System.out.println("Add values at a particular index --------------------------------------------------------");
        list.add(1,"D");
        System.out.println(list); // Output: [A, D, B, C]

        // Retrieve an object by index ---------------------------------------------------------------------------------
        System.out.println("Retrieve an object by index -------------------------------------------------------------");
        System.out.println(list.get(3)); // Output: C

        // Replacing an object at a given index ------------------------------------------------------------------------
        System.out.println("Replacing an object at a given index ----------------------------------------------------");
        list.set(0,"A+");
        System.out.println(list); // Output: [A+, D, B, C]

        // Remove an object by an index --------------------------------------------------------------------------------
        System.out.println("Remove an object by an index ------------------------------------------------------------");
        list.remove(1);
        System.out.println(list); // Output: [A+, B, C]

        // Find the index of the first occurrence of an element --------------------------------------------------------
        System.out.println("Find the index of the first occurrence of an element ------------------------------------");
        ...
        System.out.println("Find the index of the last occurrence of an object --------------------------------------");
        list.add("B");
