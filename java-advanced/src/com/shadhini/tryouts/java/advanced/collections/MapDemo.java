...
public class MapDemo {
    public static void show() {
        ...
        // Array List -- O(n) time complexity for search ===============================================================
        // Find customer with specific email -- O(n) time complexity ---------------------------------------------------
        System.out.println("Array List -- O(n) time complexity for search ===========================================");
        ...
        System.out.println("Add key value paris to Hash Map ---------------------------------------------------------");
        Map<String, Customer> customerMap = new HashMap<>();
        customerMap.put(c1.getEmail(), c1);
        customerMap.put(c2.getEmail(), c2);
        customerMap.put(c3.getEmail(), c3);

        System.out.println("Hash Map -- O(1) time complexity for search =============================================");
        // Retrieve objects from Hash Map using key --------------------------------------------------------------------
        System.out.println("Retrieve objects from Hash Map using key ------------------------------------------------");
        ...
        System.out.println("Look for object that doesn't exist in the map -------------------------------------------");
        ...
        System.out.println("Set a default value if the object we are looking for doesn't exist in the map -----------");
        ...
        System.out.println("Check whether a specific key exists in the map ------------------------------------------");
        System.out.println(customerMap.containsKey("c")); // Output: false

        // Replace an object in a map ----------------------------------------------------------------------------------
        System.out.println("Replace an object in a map --------------------------------------------------------------");
