...
public class Employee {
    ...
    public int calculateWage(int extraHours) {
        ...
        //  as many parameters required to calculate wage are attributes of this class; no need to pass them from outside.
        // The extraHours is set as a method parameter since it changes every month.
        // But base salary and hourly rate don't change that often; these are fixed values per employee for about a year.
